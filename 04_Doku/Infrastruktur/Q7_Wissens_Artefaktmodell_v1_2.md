...
| Memory | Kontextgebundene Zwischenstände eines laufenden Case | Case-Notizen, Zwischenergebnisse | an Case-Lebensdauer gebunden (siehe Q7_Workflow_Detailmodell_v1_2.md) |
...
| Policy | Regeln der Policy Engine | Zugriffsregeln, Enforcement-Bedingungen | siehe Q7_Policy_Engine_v1_3.md |
...
- Gültigkeitszeitraum
- Scope (z. B. lizenznehmerweit, abteilungsweit, prozessspezifisch)
...
Aktive Prozesse referenzieren immer eine konkrete Artefaktversion, nicht „die aktuelle Version" (siehe Bezug zu Q7_Workflow_Detailmodell_v1_2.md, Prozessversionen).
...
- Case-ID (siehe Q7_Workflow_Detailmodell_v1_2.md)
...
Die Vorfilterung über Metadaten erfolgt immer vor Volltext-/Vektorsuche, um Scope- und Berechtigungsgrenzen (siehe L6 RBAC, Q7_Policy_Engine_v1_3.md) einzuhalten, bevor inhaltlich gesucht wird.
...
3. **Scope** — spezifischerer Scope sticht bei gleichem Authority Level und gleicher Gültigkeit (z. B. lizenznehmerspezifische Regel vor plattformweiter Regel)

Kann ein Konflikt nicht eindeutig anhand dieser Reihenfolge aufgelöst werden, wird er eskaliert (siehe Q7_Workflow_Detailmodell_v1_2.md, Fehlerpfade & Eskalation) statt automatisch entschieden.
...
Es vertieft L7 (Wissensmodell) und verweist auf L6 (Erfahrungen, RBAC), Q7_Policy_Engine_v1_3.md (Retrieval-Berechtigung) und Q7_Workflow_Detailmodell_v1_2.md (Case-/Evidence-Bezug).
...
- v1.2 (19.09.2026): „mandantenweit"/„mandantenspezifische" → „lizenznehmerweit"/„lizenznehmerspezifische" (Q7-VERT2-008). Interne Querverweise auf reale Dateinamen mit Minor-Version korrigiert (Q7_Workflow_Detailmodell_v1_2.md, Q7_Policy_Engine_v1_3.md).
