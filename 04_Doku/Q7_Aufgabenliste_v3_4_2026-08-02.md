...
| Q7-A-103 | mittel | Automatische KI-Vorschlagserkennung Eingang→Aufgaben | Aktuell (V1) nur manueller "→ Zu Aufgaben"-Button auf der Eingang-Seite. Ursprüngliches Konzept: A01 erkennt automatisch Handlungsbedarf (z.B. "ruf mich zurück" in WhatsApp/E-Mail) und schlägt Verlegung proaktiv vor, mit Bestätigungspflicht. **Admin-Entscheidung 02.08.2026:** Diese Klassifizierung bleibt dauerhaft mit Rückfrage — kein Standing-Order-Lernen dafür, auch nicht bei hoher Wiederholungshäufigkeit (Abweichung von Q7-A-061-Logik für andere Tätigkeitstypen, hier bewusste Ausnahme) | Offen (02.08.2026) — Konzept bestätigt, technische Umsetzung (Erkennung durch A01) noch nicht begonnen |
