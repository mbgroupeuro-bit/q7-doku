...
**System-Version:** v5.0 | **GUI-Version:** GUI_v2.0 | **Aktualisiert:** 27.06.2026
**Änderungen seit letzter Version:** Root-Struktur erweitert (00_GUI, 99_Gefaengnis), 00_Shared + 00_Input-Validator entfernt, Abteilungskürzel-Schema überarbeitet (ST/PV + A[NR]a/b/-NR-Logik für alle Abteilungen), Hermes-Sonderrolle präzisiert, 07_Onboarding gestrichen, 06_WISSEN als Flachstruktur dokumentiert (siehe Abschnitt 15)
...
> Die Abteilungsnummer (`00`–`14`) bleibt strukturell fix; das sprechende Kürzel (ST, PV, ...) dient der Anzeige/Dokumentation.
...
| A01b | — | — | Backup PV | Springt automatisch ein bei Ausfall von A01a (Hermes) |
...
### 14.3 A11a-Failover mit Deputy-Mode (A04a)
...
## 15. STRUKTUR-UPDATES v5.0 — GF-FREIGABE 27.06.2026

> **Status:** Freigegeben durch GF am 27.06.2026. Volldetails (Ordnerpfade, Migrationsschritte) folgen in Teil C.

### 15.1 Infrastruktur — entfernte Komponenten

| Komponente | Status | Hinweis |
|---|---|---|
| `00_Shared` | ❌ ENTFERNT | Funktion entfällt, keine Nachfolge-Struktur in Teil A vorgesehen |
| `00_Input-Validator` | ❌ ENTFERNT | Funktion durch bestehende A14-Gate-Logik (Abschnitt 4b) abgedeckt |

### 15.2 05_UNTERNEHMEN — Ordner gestrichen

- `07_Onboarding` ist aus `05_UNTERNEHMEN` gestrichen. Kein Ersatzordner in Teil A definiert.

### 15.3 06_WISSEN — Flachstruktur

`06_WISSEN` führt **keine festen Unterordner**. Wissensdateien werden frei abgelegt (keine vorgegebene Kategorisierung). Gilt ab v5.0 als endgültige Struktur, nicht als Übergangszustand.
