...
**System-Version:** v23.1 | **GUI-Version:** GUI_v2.0 | **Aktualisiert:** 26.06.2026
...
|-------|-----|-----------------|
| **Grob** | Grundgedanke, Architektur, grobe Übersicht | Diese Datei |Q7_Teil_A_System.md
| **Detail** | Prozesse, Kultur, Change-Management, Bugs | `Q7_System_Detail.md` |Q7_Teil_B-SYSTEM.md 
| **Struktur** | Ordner, Agenten, Hierarchie, Zuordnungen | `Q7_System_Struktur.md` |Q7_Teil_C_System
...
> **Vollständige Struktur aller Unterordner → siehe `Q7_System_Struktur.md`**
...
> **Alle Hierarchie-Regeln im Detail → siehe `Q7_System_Detail.md` Kap. 1**
...
> **Vollständiges Change-Management → siehe `Q7_System_Detail.md` Kap. 29**
...
| A11 | Systemcontrolling (5 Agenten) | Überwachung, Anomalien, Systemgesundheit |
...
> **Vollständige Agentenliste pro Abteilung → siehe `Q7_Teil_C_System.md` unter 04_Doku Ordner wird weiterführend geführt nach versionen**

---

## 7. KERNPROZESS — KUNDENANALYSE 

Es gibt Systemprozesse des System vom Eingang des Inhalts bis zur Umwandlung zum internen Auftrag. 

Der Kundenprozesse des Systems — von Kundenkontakt bis Freigabe:

Prozesse: Systemprozesse und Kundenprozesse

> **Vollständiges Prozess-Register mit allen Regeln → siehe `Q7_System_Detail.md` Kap. 27**
...
> **Vollständige Kultur mit Code of Conduct, Entscheidungsmaximen, Geschäftsprinzipien → siehe `Q7_System_Detail.md` Kap. 28**
...
01_INPUT/01_Quarantäne
   ↓ H-01: 3-Filter-Sicherheitsschleuse (max. 15 Min SLA)
   ↓ 01_INPUT/02_Eingang
   ...
   ↓ Fachabteilungen A02 Facharbeit
...
## 10. GUI — FÜNF MODULE + BUGS (für die Zukunft am ende)
