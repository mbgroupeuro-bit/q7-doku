...
**Basis:** v23.1 (2026-06-27) | **Typ:** Vollständige Regelreferenz
...
└── 📁 09_Kunden
    └── 📁 KD_[Nr]_[Name]/
        ├── stammdaten.md     ← Kundenstammdaten, Auftragsformular, Analyseergebnisse, Präsentationen
```
...
Alle Prozessdetails leben ausschließlich in den jeweiligen Prozessdokumenten. Systemdokumentation verweist nur auf Prozess-ID. In Dokument Q7_Teil_C_System.md werden alle Infos laufend aktualisiert.
...
| **P_016** | **Kunden-Analyse & Transformationsprozess — Kundenprozesse** | **GF + Hermes + Fachabteilungen** |
...
**HART:** 7-Ordner-Grundarchitektur · GF als einziger Entscheider · Quarantäne-3-Filter · Audit-Trail/Hash-Validierung · RBAC-Grundprinzip · Master/Backup-Failover-Logik · A14-Gate-Mechanismus
...
### Aktueller Bug-Status (Stand v23.1)
...
## KAP. 31 — OFFENE PENDENZEN (Stand v23.1)
...
| ID | Thema | Frage an GF |
|----|-------|-------------|
| P23-08 | Auftragsformular Footer | Footer auf v23.1 aktualisieren? |
| P23-09 | P_016.9 Beispielzeilen | `[Beispiel]`-Markierung ergänzen? |

---

*Teil B — Detail | Basis: Q7 v23.1 | Überblick: Teil A | Agenten/Struktur: Teil C*
