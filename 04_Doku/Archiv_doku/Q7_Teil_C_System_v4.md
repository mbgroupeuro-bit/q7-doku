# Q7_Teil_C_System_v4.md — STRUKTUR & PROZESS-REGISTER

**System-Version:** v4.0 | **Aktualisiert:** 30.06.2026  
**Änderungen seit v3.0:** C-06 Abschnitt 1 KD_Neu/ → KD_[Nr] direkt (Tresor-Pfad korrigiert) · C-07 Abschnitt 1 01_Quarantäne-Zugriff auf A14+GF präzisiert · C-08 Abschnitt 1 02_Eingang-Zeile korrigiert · C-09 Abschnitt 3 A14b ergänzt, A01 monolithisch-Notiz, A14-Beschreibung erweitert
...
*Teil C — Struktur & Prozess-Register | Basis: Q7 v4.0 | Überblick: Teil A | Detail: Teil B*
