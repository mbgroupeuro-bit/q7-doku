# Q7_Teil_B_System_v6.md — TEIL B: DETAIL
**Basis:** v23.5 (2026-06-28) | **Typ:** Vollständige Regelreferenz
...
Input wird in 01_INPUT/02_Eingang verschoben
   ↓
Hermes (A01): Workflow erstellen → Verarbeitung beginnt
   ↓
...
> **Klarstellung (TL-03, Testlauf-Befund):** "H-04b" ist kein Hermes-interner Prüfschritt, sondern der Trigger-Punkt im Hermes-Flow, an dem A05a (Abteilungsleiter QM, eigenständig) den Freigabe-Check real durchführt. Hermes/H-04 übergibt an A05a und wartet auf dessen Ergebnis (FREIGABE-BEREIT / zurück an Fachabteilung) — Hermes prüft diesen Schritt nicht selbst. Begründung: A05 ist laut Teil C "unabhängig, wie A14" — diese Unabhängigkeit wäre hinfällig, würde Hermes den Schritt intern abwickeln.
...
| BUG_20260620_007 | CRITICAL | GF | A14 Grundlagen-Dateien noch nicht erstellt | OFFEN — Schritt 1: 4 Dateien erstellen. **GF-Notiz (TL-02, 28.06.2026): A14-Aufbau ist nächste Priorität, zusammen mit Hermes + GF im Cowork-Setup.** |
