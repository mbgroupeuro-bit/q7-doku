# Q7_Teil_B_System_v8.md — TEIL B: DETAIL
**Basis:** v23.7 (2026-07-02) | **Typ:** Vollständige Regelreferenz
**Überblick:** → Teil A | **Agenten & Ordnerstruktur:** → Teil C

**Änderungen seit v7 (Basis v23.6 → v23.7, 02.07.2026):**
B-08 Kap. 31 — GF-Entscheidungs-Queue P23-02 bis P23-09 final entschieden (siehe Statusspalte) · B-09 Kap. 27a — P23-02-Entscheid im DNA-Max-Score-Abschnitt vermerkt
...
**Status P23-02 (GF-Entscheid 02.07.2026):** Korrektur auf 1.285 freigegeben — Umsetzung in
`dna-auswertung-intern_VORLAGE.md` + `dna-endergebnis` erst nach Gegenprüfung der K1–K6-Herleitung
(Score = E × M, siehe oben) durch A01a/Hermes. Bis Gegenprüfung abgeschlossen: aktueller Wert bleibt gültig.
...
| ID | Thema | Status (GF-Entscheid 02.07.2026) |
|----|-------|-------------|
| ~~P23-01~~ | ~~A14 Grundlagen-Dateien~~ | ✅ ERLEDIGT (30.06.2026) — 5 Dateien erstellt, Architektur konsolidiert |
| P23-02 | DNA Max-Score Korrektur | ⏳ FREIGEGEBEN, IN PRÜFUNG — Korrektur auf 1.285 freigegeben, Umsetzung erst nach Gegenprüfung K1–K6-Herleitung durch A01a/Hermes (siehe Kap. 27a) |

### 🟠 MITTEL

| ID | Thema | Status (GF-Entscheid 02.07.2026) |
|----|-------|-------------|
| P23-03 | P_016.8a Ablageort | ⏳ ZURÜCKGESTELLT — Verschiebung nach `07_Bedarfsanalyse/` erst nach Klärung, wie dieser Ordner in die 9-Ordner-Architektur (Teil C) eingeordnet wird. `07_Bedarfsanalyse/` ist aktuell nirgends in Teil C definiert. |
| P23-04 | Scope-Unterschied Checkliste vs. P_016.8a | ✅ FREIGEGEBEN — Section 5 erhält expliziten Verweis auf P_016.8a |
| P23-05 | Mystery Guest Audit Standard | ✅ FREIGEGEBEN — Standard nur bei Kundentypen mit physischem Standort (z.B. Restaurant, Einzelhandel); digitale Dienstleister ausgenommen |
| P23-06 | DNA Sub-Prozesse | ✅ FREIGEGEBEN — eigene Prozess-ID nur für Stränge mit eigenständigem Workflow (z.B. Mystery Shopping); übrige Stränge bleiben P_016.x-Unterschritte |
| P23-07 | Finanz-Benchmarks | ⏳ ZURÜCKGESTELLT — Integration erst nach Abschluss laufende Testphase (P_028 SWOT / P_030 Gap-Analyse, KD_002) |

### 🟡 MINOR

| ID | Thema | Status (GF-Entscheid 02.07.2026) |
|----|-------|-------------|
| P23-08 | Auftragsformular Footer | ✅ FREIGEGEBEN — Footer sofort auf v23.3 aktualisieren |
| P23-09 | P_016.9 Beispielzeilen | ✅ FREIGEGEBEN — `[Beispiel]`-Markierung nur bei Zeilen mit Verwechslungsgefahr zu echten Kundendaten, nicht pauschal |

**Offene Folgeaufgaben aus dieser Runde:**
- A01a/Hermes: K1–K6-Herleitung für P23-02 gegenprüfen, dann 1.285 in beide Zieldateien übernehmen
- Struktur-Entscheidung: Einordnung `07_Bedarfsanalyse/` in Teil C (Voraussetzung für P23-03)
- A09 (Dokumentation): Section 5 der Checkliste um P_016.8a-Verweis ergänzen (P23-04)
- Auftragsformular-Footer aktualisieren (P23-08)
- P_016.9-Datei: gezielte `[Beispiel]`-Markierung prüfen (P23-09)

---

*Teil B — Detail | Basis: Q7 v23.7 | Überblick: Teil A | Agenten/Struktur: Teil C*
