...
Artefaktscharfe Vertiefung (Unterscheidung Knowledge/Memory/Experience/Policy als eigene Artefaktklassen, Verbindlichkeitsstufen, Version Registry, Execution Evidence Record, Konfliktregelung bei widersprüchlichem Wissen): `04_Doku/Infrastruktur/Q7_Wissens_Artefaktmodell_v1_2.md`
...
Feingranulare, attributbasierte Zugriffsregeln (ABAC) für Retrieval: siehe Q7_Policy_Engine_v1_3.md, Enforcement Point „Zugriff auf zentrale Wissensbasis".
...
- v1.4 (21.09.2026): Dokument war beim Terminologie-Wechsel vom 26.07.2026 und beim layerweiten Konsistenz-Check vom 19.09.2026 übersprungen worden — mit dieser Version vollständig nachgezogen (Q7-L7-001). Terminologie "GF" → "Admin" durchgängig (Lebenszyklus, Akzeptanzkriterien, Änderungsregel). Querverweise korrigiert: `07_DOKU/Infrastruktur/Q7_Wissens_Artefaktmodell_v1.md` → `04_Doku/Infrastruktur/Q7_Wissens_Artefaktmodell_v1_2.md` (falscher Ordner und falsche Version behoben); `Q7_Policy_Engine_v1.md` → `Q7_Policy_Engine_v1_3.md`. Dateiname korrigiert von `L7_Q7_wissensmodell` (ohne Version, Kleinschreibung) auf `L7_Q7_Wissensmodell_v1_4.md`.
